...
public class EventBookingCancellationNotValidException extends BadRequestException {
    public EventBookingCancellationNotValidException(final LocalDate bookingDate) {
        super(new Error(
    ...
    public EventBookingCancellationNotValidException(final LocalDate bookingDate, final Throwable cause) {
        super(new Error(
                        _ExceptionConstants.WORKPLACE_BOOKING_CANCELLATION_NOT_VALID.getCode(),
                        _ExceptionConstants.WORKPLACE_BOOKING_CANCELLATION_NOT_VALID.getTitle(),
                        String.format(_ExceptionConstants.WORKPLACE_BOOKING_CANCELLATION_NOT_VALID.getDetail(), bookingDate)
