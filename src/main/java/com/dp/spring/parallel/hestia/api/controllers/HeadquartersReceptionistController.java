...
@RequestMapping("/api/hestia/v1/companies/{companyId}/headquarters/{headquartersId}/headquarters-receptionist")
public interface HeadquartersReceptionistController {
